        ...
        <div className={"dx-card responsive-paddings"}>
          <div className={"logos-container"}>
            ...
            >
              <path
                d={
                  "M21.6309 13.3433H13.1714V21.8027H8.73291V13.3433H0.229492V8.88281H8.73291V0.379395H13.1714V8.88281H21.6309V13.3433Z"
                }
                fill={"#BCBCBC"}
              />
            </svg>
          ...
          <p>
            To customize your DevExtreme React application further, please refer
            to the following help topics:
          </p>
          ...
          <ul>
            <li>
              <a
                href={
                  "https://js.devexpress.com/Documentation/Guide/React_Components/Application_Template/#Layouts"
                }
                target={"_blank"}
                rel={"noopener noreferrer"}
              >
            ...
            <li>
              <a
                href={
                  "https://js.devexpress.com/Documentation/Guide/React_Components/Application_Template/#Add_a_New_View"
                }
                target={"_blank"}
                rel={"noopener noreferrer"}
              >
            ...
            <li>
              <a
                href={
                  "https://js.devexpress.com/Documentation/Guide/React_Components/Application_Template/#Configure_the_Navigation_Menu"
                }
                target={"_blank"}
                rel={"noopener noreferrer"}
              >
            ...
            <li>
              <a
                href={
                  "https://js.devexpress.com/Documentation/Guide/React_Components/Application_Template/#Configure_Themes"
                }
                target={"_blank"}
                rel={"noopener noreferrer"}
              >
